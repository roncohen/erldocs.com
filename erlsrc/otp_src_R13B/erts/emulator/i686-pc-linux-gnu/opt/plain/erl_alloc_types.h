 ...
 *       'make_alloc_types' on Fri Jul 31 14:49:33 2009.
 *
 * -----------------------------------------------------------------------
 *
 * 
...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (45)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (46)
#define ERTS_ALC_N_MAX_A_STANDARD (77)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (78)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (103)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (104)
#define ERTS_ALC_N_MAX_A_EHEAP (106)

/* Type numbers used for ets_alloc */
#define ERTS_ALC_N_MIN_A_ETS (107)
#define ERTS_ALC_N_MAX_A_ETS (114)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (115)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (126)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (127)
#define ERTS_ALC_N_MAX_A_BINARY (128)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (129)
#define ERTS_ALC_N_MAX_A_DRIVER (135)

#define ERTS_ALC_N_MAX (135)
...
#define ERTS_ALC_T_FD_LIST (5715)
#define ERTS_ALC_T_POLLSET_UPDREQ (5843)
#define ERTS_ALC_T_LINK_LH (5908)
#define ERTS_ALC_T_MONITOR_LH (6036)
#define ERTS_ALC_T_NLINK_LH (6164)
#define ERTS_ALC_T_SUSPEND_MON (6292)
#define ERTS_ALC_T_LL_BIF_TIMER (6420)
#define ERTS_ALC_T_REG_TABLE (6612)
#define ERTS_ALC_T_FUN_TABLE (6756)
#define ERTS_ALC_T_DIST_TABLE (6868)
#define ERTS_ALC_T_NODE_TABLE (6996)
#define ERTS_ALC_T_MODULE_REFS (7140)
#define ERTS_ALC_T_DCACHE (7252)
#define ERTS_ALC_T_DIST_ENTRY (7380)
#define ERTS_ALC_T_NODE_ENTRY (7508)
#define ERTS_ALC_T_DRIVER (7636)
#define ERTS_ALC_T_ARG_REG (7700)
#define ERTS_ALC_T_PROC_DICT (7828)
#define ERTS_ALC_T_CALLS_BUF (7956)
#define ERTS_ALC_T_BPD (8148)
#define ERTS_ALC_T_PORT_NAME (8276)
#define ERTS_ALC_T_LINEBUF (8404)
#define ERTS_ALC_T_IOQ (8532)
#define ERTS_ALC_T_BITS_BUF (8660)
#define ERTS_ALC_T_DB_NTAB_ENT (8740)
#define ERTS_ALC_T_DDLL_PROCESS (8916)
#define ERTS_ALC_T_DDLL_HANDLE (9044)
#define ERTS_ALC_T_PORT_DATA_LOCK (9172)
#define ERTS_ALC_T_NODES_MON (9236)
#define ERTS_ALC_T_RE_HEAP (9428)
#define ERTS_ALC_T_PSD (9492)
#define ERTS_ALC_T_PRTSD (9684)
#define ERTS_ALC_T_FD_ENTRY_BUF (9812)
#define ERTS_ALC_T_PRT_REP_EXIT (9940)
#define ERTS_ALC_T_ATOM_TXT (10053)
#define ERTS_ALC_T_BIF_TIMER_TABLE (10197)
#define ERTS_ALC_T_ATOM_TABLE (10309)
#define ERTS_ALC_T_EXPORT_TABLE (10469)
#define ERTS_ALC_T_MODULE_TABLE (10597)
#define ERTS_ALC_T_PROC_TABLE (10645)
#define ERTS_ALC_T_PORT_TABLE (10837)
#define ERTS_ALC_T_TIMER_WHEEL (10965)
#define ERTS_ALC_T_CODE (11109)
#define ERTS_ALC_T_ASYNC_Q (11221)
#define ERTS_ALC_T_DB_TABLES (11301)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (11429)
#define ERTS_ALC_T_INSTR_INFO (11605)
#define ERTS_ALC_T_SCHDLR_DATA (11669)
#define ERTS_ALC_T_RUNQS (11861)
#define ERTS_ALC_T_DDLL_ERRCODES (11989)
#define ERTS_ALC_T_PRE_ALLOC_DATA (12117)
#define ERTS_ALC_T_CPUDATA (12245)
#define ERTS_ALC_T_DRV_TAB (12373)
#define ERTS_ALC_T_DRV_EV_STATE (12501)
#define ERTS_ALC_T_POLLSET (12629)
#define ERTS_ALC_T_POLL_FDS (12757)
#define ERTS_ALC_T_POLL_RES_EVS (12885)
#define ERTS_ALC_T_FD_STATUS (13013)
#define ERTS_ALC_T_FD_TAB (13141)
#define ERTS_ALC_T_CS_PROG_PATH (13269)
#define ERTS_ALC_T_HEAP (13334)
#define ERTS_ALC_T_OLD_HEAP (13462)
#define ERTS_ALC_T_HEAP_FRAG (13590)
#define ERTS_ALC_T_DB_SEG (13735)
#define ERTS_ALC_T_DB_SEG_TAB (13863)
#define ERTS_ALC_T_DB_STK (13991)
#define ERTS_ALC_T_DB_TRANS_TAB (14119)
#define ERTS_ALC_T_DB_SEL_LIST (14247)
#define ERTS_ALC_T_DB_DMC_ERROR (14375)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (14503)
#define ERTS_ALC_T_DB_TERM (14631)
#define ERTS_ALC_T_PROC (14744)
#define ERTS_ALC_T_ATOM (14920)
#define ERTS_ALC_T_EXPORT (15080)
#define ERTS_ALC_T_MODULE (15208)
#define ERTS_ALC_T_REG_PROC (15256)
#define ERTS_ALC_T_MONITOR_SH (15384)
#define ERTS_ALC_T_NLINK_SH (15512)
#define ERTS_ALC_T_PROC_LIST (15640)
#define ERTS_ALC_T_FUN_ENTRY (15848)
#define ERTS_ALC_T_DB_TABLE (15912)
#define ERTS_ALC_T_DRV_EV_D_STATE (16088)
#define ERTS_ALC_T_DRV_SEL_D_STATE (16216)
#define ERTS_ALC_T_DRV_BINARY (16313)
#define ERTS_ALC_T_BINARY (16441)
#define ERTS_ALC_T_DRV (16602)
#define ERTS_ALC_T_DRV_THR_OPTS (16730)
#define ERTS_ALC_T_DRV_TID (16858)
#define ERTS_ALC_T_DRV_MTX (16986)
#define ERTS_ALC_T_DRV_CND (17114)
#define ERTS_ALC_T_DRV_RWLCK (17242)
#define ERTS_ALC_T_DRV_TSD (17370)
