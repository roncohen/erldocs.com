 ...
 *       'make_alloc_types' on Fri Jul 31 14:49:54 2009.
 *
 * -----------------------------------------------------------------------
 *
 * 
...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (48)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (49)
#define ERTS_ALC_N_MAX_A_STANDARD (83)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (84)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (113)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (114)
#define ERTS_ALC_N_MAX_A_EHEAP (116)

/* Type numbers used for ets_alloc */
#define ERTS_ALC_N_MIN_A_ETS (117)
#define ERTS_ALC_N_MAX_A_ETS (124)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (125)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (136)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (137)
#define ERTS_ALC_N_MAX_A_BINARY (138)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (139)
#define ERTS_ALC_N_MAX_A_DRIVER (145)

#define ERTS_ALC_N_MAX (145)
...
#define ERTS_ALC_T_XPORTS_LIST (5715)
#define ERTS_ALC_T_SL_PTIMER (5843)
#define ERTS_ALC_T_SYS_MSG_Q (5907)
#define ERTS_ALC_T_FD_LIST (6099)
#define ERTS_ALC_T_POLLSET_UPDREQ (6227)
#define ERTS_ALC_T_LINK_LH (6292)
#define ERTS_ALC_T_MONITOR_LH (6420)
#define ERTS_ALC_T_NLINK_LH (6548)
#define ERTS_ALC_T_SUSPEND_MON (6676)
#define ERTS_ALC_T_LL_BIF_TIMER (6804)
#define ERTS_ALC_T_REG_TABLE (6996)
#define ERTS_ALC_T_FUN_TABLE (7140)
#define ERTS_ALC_T_DIST_TABLE (7252)
#define ERTS_ALC_T_NODE_TABLE (7380)
#define ERTS_ALC_T_MODULE_REFS (7524)
#define ERTS_ALC_T_DCACHE (7636)
#define ERTS_ALC_T_DIST_ENTRY (7764)
#define ERTS_ALC_T_NODE_ENTRY (7892)
#define ERTS_ALC_T_DRIVER (8020)
#define ERTS_ALC_T_ARG_REG (8084)
#define ERTS_ALC_T_PROC_DICT (8212)
#define ERTS_ALC_T_CALLS_BUF (8340)
#define ERTS_ALC_T_BPD (8532)
#define ERTS_ALC_T_PORT_NAME (8660)
#define ERTS_ALC_T_LINEBUF (8788)
#define ERTS_ALC_T_IOQ (8916)
#define ERTS_ALC_T_BITS_BUF (9044)
#define ERTS_ALC_T_DB_NTAB_ENT (9124)
#define ERTS_ALC_T_DDLL_PROCESS (9300)
#define ERTS_ALC_T_DDLL_HANDLE (9428)
#define ERTS_ALC_T_PORT_DATA_LOCK (9556)
#define ERTS_ALC_T_NODES_MON (9620)
#define ERTS_ALC_T_RE_HEAP (9812)
#define ERTS_ALC_T_PSD (9876)
#define ERTS_ALC_T_PRTSD (10068)
#define ERTS_ALC_T_PORT_LOCK (10196)
#define ERTS_ALC_T_DRIVER_LOCK (10324)
#define ERTS_ALC_T_LL_PTIMER (10452)
#define ERTS_ALC_T_FD_ENTRY_BUF (10580)
#define ERTS_ALC_T_PRT_REP_EXIT (10708)
#define ERTS_ALC_T_ATOM_TXT (10821)
#define ERTS_ALC_T_BIF_TIMER_TABLE (10965)
#define ERTS_ALC_T_ATOM_TABLE (11077)
#define ERTS_ALC_T_EXPORT_TABLE (11237)
#define ERTS_ALC_T_MODULE_TABLE (11365)
#define ERTS_ALC_T_PROC_TABLE (11413)
#define ERTS_ALC_T_PORT_TABLE (11605)
#define ERTS_ALC_T_TIMER_WHEEL (11733)
#define ERTS_ALC_T_CODE (11877)
#define ERTS_ALC_T_ASYNC_Q (11989)
#define ERTS_ALC_T_DB_TABLES (12069)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (12197)
#define ERTS_ALC_T_INSTR_INFO (12373)
#define ERTS_ALC_T_SCHDLR_DATA (12437)
...
#define ERTS_ALC_T_PROC_LCK_WTR (13141)
#define ERTS_ALC_T_PROC_LCK_QS (13269)
#define ERTS_ALC_T_RUNQ_BLNS (13397)
#define ERTS_ALC_T_FP_EXCEPTION (13525)
#define ERTS_ALC_T_DRV_TAB (13653)
#define ERTS_ALC_T_DRV_EV_STATE (13781)
#define ERTS_ALC_T_POLLSET (13909)
#define ERTS_ALC_T_POLL_FDS (14037)
#define ERTS_ALC_T_POLL_RES_EVS (14165)
#define ERTS_ALC_T_FD_STATUS (14293)
#define ERTS_ALC_T_FD_TAB (14421)
#define ERTS_ALC_T_CS_PROG_PATH (14549)
#define ERTS_ALC_T_HEAP (14614)
#define ERTS_ALC_T_OLD_HEAP (14742)
#define ERTS_ALC_T_HEAP_FRAG (14870)
#define ERTS_ALC_T_DB_SEG (15015)
#define ERTS_ALC_T_DB_SEG_TAB (15143)
#define ERTS_ALC_T_DB_STK (15271)
#define ERTS_ALC_T_DB_TRANS_TAB (15399)
#define ERTS_ALC_T_DB_SEL_LIST (15527)
#define ERTS_ALC_T_DB_DMC_ERROR (15655)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (15783)
#define ERTS_ALC_T_DB_TERM (15911)
#define ERTS_ALC_T_PROC (16024)
#define ERTS_ALC_T_ATOM (16200)
#define ERTS_ALC_T_EXPORT (16360)
#define ERTS_ALC_T_MODULE (16488)
#define ERTS_ALC_T_REG_PROC (16536)
#define ERTS_ALC_T_MONITOR_SH (16664)
#define ERTS_ALC_T_NLINK_SH (16792)
#define ERTS_ALC_T_PROC_LIST (16920)
#define ERTS_ALC_T_FUN_ENTRY (17128)
#define ERTS_ALC_T_DB_TABLE (17192)
#define ERTS_ALC_T_DRV_EV_D_STATE (17368)
#define ERTS_ALC_T_DRV_SEL_D_STATE (17496)
#define ERTS_ALC_T_DRV_BINARY (17593)
#define ERTS_ALC_T_BINARY (17721)
#define ERTS_ALC_T_DRV (17882)
#define ERTS_ALC_T_DRV_THR_OPTS (18010)
#define ERTS_ALC_T_DRV_TID (18138)
#define ERTS_ALC_T_DRV_MTX (18266)
#define ERTS_ALC_T_DRV_CND (18394)
#define ERTS_ALC_T_DRV_RWLCK (18522)
#define ERTS_ALC_T_DRV_TSD (18650)
